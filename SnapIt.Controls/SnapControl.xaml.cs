...
public partial class SnapControl : UserControl
{
    ...
    {
        Layout.Size = new SnapIt.Common.Graphics.Size((float)ActualWidth, (float)ActualHeight);
    }
    ...
    public void GenerateSnapAreas()
    {
        ...
        SnapIt.Common.Math.FindRectangle.Settings settings = new SnapIt.Common.Math.FindRectangle.Settings
        {
